...
<body>
 ...
 {
    %>
    <center><font color="red" size="5">Form Submitted Succefully. You Will get notified within 24 hours</font></center>
    <%
 }
 %>
 <%
 ...
 {
    %>
    <center><font color="red" size="5">Something went wrong please check proprely Try Again!</font></center>
    <%
 }
 %>  
